...
import fun.longtao.waiter.controller.request.NewCoffeeRequest;
...
public class CoffeeController {
    ...
    @ResponseBody
    public Object findCoffeeById(HttpSession session, @RequestParam Long id) {
        Coffee coffee = coffeeMapper.selectByPrimaryKey(id);
        log.info("coffee first:{}", coffee.toString());
...
//    }
    ...
    @GetMapping(path = "/getByMoneyLess", params = "price")
    @ResponseBody
    public List<Coffee> getByMoneyLess(@RequestParam Money price) {
        return coffeeService.getByMoneyLess(price);
    }
